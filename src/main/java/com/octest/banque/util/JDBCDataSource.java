 ...
 * JDBC DataSource is a Data Connection Pool
 Interface qui hérite de  CommonDataSource et Wrapper Class. 
  Contient deux méthodes getConnection () et getConnection (chaine nom d'utilisateur, chaine mot de passe)
  Une  alternative  DriverManager utilise pour creer une connexion au pool,
   ...
   aidera  lire les données du fichier "system.properties" et créer un pool de connexion
 * 
 */
